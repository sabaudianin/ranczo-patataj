    ...
    <section className="py-8 space-y-12">
      ...
      <div className="md:hidden space-y-4">
        ...
        <div className="rounded-3xl overflow-hidden shadow-xl border-4 ">
          <iframe
            id="mapa"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2475.243555986873!2d20.7303!3d51.6521!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNTHCsDM5JzA3LjYiTiAyMMKwNDMnNDkuMSJF!5e0!3m2!1spl!2spl!4v1710000000000"
            width="100%"
            height="250"
            loading="lazy"
            className=""
